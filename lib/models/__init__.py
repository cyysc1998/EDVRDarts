...
__all__ = ['change_key', 'get_cell_based_tiny_net', 'get_search_spaces', 'get_cifar_models', 'get_imagenet_models', \
           ...
           'CellStructure', 'CellArchitectures', 'get_edvrdarts_model'
           ]
...
def get_edvrdarts_model(config):
    from models.cell_searchs import EDVRDarts
    return EDVRDarts(config.C, config.N, config.max_nodes, config.space, config.affine, config.track_running_stats)
