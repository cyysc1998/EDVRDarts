...
from models import get_cell_based_tiny_net, get_search_spaces, get_edvrdarts_model
...
def main(xargs):
    ...
    search_space = get_search_spaces("cell", xargs.search_space_name) # 获取cell_operations.py中SearchSpaceNames定义某类的ops
    ...
    # search_model = get_cell_based_tiny_net(model_config) # 获取整个模型，分为ResNetBasicblock、Search Cell等（search_model_darts.py）
    search_model = get_edvrdarts_model(model_config)
